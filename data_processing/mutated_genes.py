...
def process_mutations_in_batches(
    ...
    for batch_num in range(total_batches):
        ...
        if valid_mask.any():
            ...
            # Generate peptides
            # ⚡ Bolt Optimization: Use list comprehension with itertuples/zip instead of apply(axis=1)
            # This is significantly faster for row-wise operations in pandas DataFrames.
