...
def validate_peptides(peptides: pd.Series) -> Tuple[bool, Dict]:
    ...
    # Optimization: Use str.contains instead of apply(lambda) for 3x faster execution
    invalid_aa = peptides.str.contains(r'[^ACDEFGHIKLMNPQRSTVWY]', regex=True, na=False)
    ...
    # Optimization: Use str.len() instead of apply(lambda)
